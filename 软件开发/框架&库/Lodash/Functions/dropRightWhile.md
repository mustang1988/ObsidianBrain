---
# 函数签名
Signature: "dropRightWhile(array, [predicate=_.identity)"
# 函数分类
Category:
  - "Array"
# 函数说明
...
ExtraComment:
  - Type: "quote"
    ...
    Content: 
      ...
      - "与 [[dropWhile]] 函数类似, 区别在于 [[dropWhile]] 函数会忽略原始数组 ***前端*** 部分元素, 本函数则会忽略原始数组 ***后端*** 部分元素"
...
Arguments:
  ...
  - Name: "predicate"
    Type: "Function"
    Required: false
    Comment: "[[dropRightWhile的predicate回调函数]]"
    Default: "[[identity]]"
# 函数返回值
Return:
  Type: "Array"
